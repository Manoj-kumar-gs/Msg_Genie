      ...
      <div className="bg-slate-50 p-8 flex flex-col justify-center items-start rounded-lg min-w-[85%] md:min-w-[25%] my-auto">
        <Form {...form}>
          <form
            ...
            className="space-y-6 w-full flex flex-col justify-center items-start"
          >
            <FormField
            ...
            <button
              ...
              className="mt-4 px-4 py-2 w-[80%] cursor-pointer bg-indigo-600 text-white rounded-md shadow-md hover:shadow-cyan-500 transition-all duration-100 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
            ...
            {/* Sign‑in link: use routing handler */}
