...
const Page = () => {
  ...
  return (
    <div className="bg-white flex md:flex-row flex-col justify-center items-center gap-4 min-h-[80vh] py-2">
        <div className="bg-slate-50 p-8 flex flex-col justify-center items-start rounded-lg min-w-[85%] md:min-w-[25%]">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full flex flex-col justify-center items-start">
              ...
              />
              <button type="submit" disabled={isSubmiting} className="mt-4 px-4 py-2 w-[80%] cursor-pointer bg-indigo-600 text-white rounded-md shadow-md hover:shadow-cyan-500 transition-all duration-100 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed">
                {isSubmiting ? (
                  <>
      ...
      <div className="flex flex-col justify-center items-center gap-10 w-full md:w-[50%]">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-center text-gray-500 font-bold mt-2">
            Share your link in your bio. Let others send anonymous or
          </p>
          <p className="text-center text-gray-500 font-bold mt-2">
        ...
        <div>
          <div className="flex flex-col justify-center items-center mb-4 gap-3">
            <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
              className="hover:cursor-pointer flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          ...
          <div className=" text-gray-500 mt-2 flex justify-center items-center gap-2 pb-2">
            <Link href={"/sign-up"} className="text-blue-500 hover:underline hover:text-blue-600">Sign In</Link> <p className="font-semibold"> to get started. </p>
          </div>
        </div>
      </div>
    </div>
