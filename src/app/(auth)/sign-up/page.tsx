...
const page = () => {
    ...
    return (
        <div className="bg-white flex justify-center items-center min-h-[80vh]">
            <div className="bg-slate-50 p-8 flex flex-col justify-center items-start rounded-lg min-w-[30%] my-auto">
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-full flex flex-col justify-center items-start">
                        <FormField
            ...
            <div className="flex flex-col justify-center items-center gap-10 w-[50%]">
                ...
                <div>
                    ...
                    <div className=" text-gray-500 mt-2 flex justify-center items-center gap-2">
                        <p className="font-semibold"> Already have an account? </p> <Link href={"/sign-in"} className="text-blue-500 hover:underline hover:text-blue-600">Sign In</Link>
                    </div>
                </div>
            </div>
        </div>
