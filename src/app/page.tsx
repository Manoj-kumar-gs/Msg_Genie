...
export default function Home() {
  const autoplayPlugin = useRef(
    Autoplay({
       ...
       stopOnMouseEnter:true }) // 3s delay
  )
  return (
    <div className="">
      <main>
        <section className="flex flex-col justify-evenly items-center h-[20vh]">
          <div className="text-[20px] font-bold">Hello there!, Welcome to ChatUsingAi</div>
          <div className="text-lg font-semibold">Use suggestions from Artificial Inteligence to suggest your suggestion to your friends</div>
        </section>
        <div className="w-full flex justify-center items-center h-[60vh]">
          <div className="flex flex-col justify-center gap-6 items-center h-full w-[60vw]">
